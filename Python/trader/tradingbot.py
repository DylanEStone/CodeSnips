...
api = tradeapi.REST(key_id='PKA27SL182C3QTRT1P2Y',secret_key='v72oiD7zbBkg75oK4wF5wHY7IpL6UcvaxKBLtUmk')

barTimeframe = "1H" # 1Min, 5Min, 15Min, 1H, 1D
# assetsToTrade = ["SPY","MSFT","AAPL","NFLX"]
assetsToTrade = ["PTN","VERU","HCHC","APHA"]
positionSizing = 0.25
...
while iteratorPos < assetListLen:
	...
	returned_data = api.get_barset(symbols,timeframe,limit=100,start=None,end=None,after=None,until=None).bars
